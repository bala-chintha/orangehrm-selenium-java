...
public class AddUserPage extends BasePage {
    ...
    private final By autoCompleteSuggestion = By.xpath("//div[@role='option' and contains(@class,'oxd-autocomplete-option')]");
    ...
    public void fillEmployeeName(String name) throws InterruptedException {
        typeInAutocomplete(employeeNameInput, autoCompleteSuggestion, name);
    }
