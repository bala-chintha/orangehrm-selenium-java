...
public abstract class BasePage {
    ...
    public WebElement waitForPageReadyBounded(By targetElement) {
        return pageLoader.waitForPageReadyBounded(targetElement);
    }
    ...
    public void typeInAutocomplete(By inputLocator, By suggestionsLocator, String searchText) throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebElement suggestion = wait.until(ExpectedConditions.visibilityOfElementLocated(suggestionsLocator));
        suggestion.click();
    }
