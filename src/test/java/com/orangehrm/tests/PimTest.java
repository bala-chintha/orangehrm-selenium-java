...
public class PimTest extends BaseTest {
    ...
    private Employee createEmployee() {
        ...
        pimPage.clickAdd();
        addEmployeePage.fillDetails(employee.firstName, employee.middleName, employee.lastName, employee.employeeId);
    ...
    public void shouldLoadEmployeeListWithRecords() {
        ...
        Assert.assertTrue(count > 0, "Employee list should have at least one record, but found: " + count);
    }
    ...
    public void shouldAddNewEmployeeSuccessfully() {
        ...
        Assert.assertTrue(message.contains("Successfully Saved"), "Success toast should contain 'Successfully Saved', actual: " + message);
    }
    ...
    public void shouldEditEmployeeSuccessfully() {
        ...
        addEmployeePage.editEmployeeDetails(employee.firstName, employee.middleName, updatedLastName);
        addEmployeePage.save();

        String message = addEmployeePage.getSuccessMessage();
        Assert.assertTrue(message.contains("Successfully Updated"), "Success toast should contain 'Successfully Updated', actual: " + message);
    }
    ...
    public void shouldDeleteEmployeeSuccessfully() {
        ...
        pimPage.searchByName(employee.lastName);
        Assert.assertTrue(pimPage.isNoRecordsFound(), "Deleted employee should not appear in search results");
    }
    ...
    public void shouldSearchEmployeeByNameAndFindResults() {
        ...
        int count = pimPage.getRowCount();
        Assert.assertTrue(count > 0, "Search for '" + EmployeeData.KNOWN_FIRST_NAME + "' should return at least one result");
    }
    ...
    public void shouldShowNoRecordsForInvalidSearch() {
        ...
        Assert.assertTrue(pimPage.isNoRecordsFound(), "Searching for '" + EmployeeData.NONEXISTENT_NAME + "' should show 'No Records Found'");
    }
