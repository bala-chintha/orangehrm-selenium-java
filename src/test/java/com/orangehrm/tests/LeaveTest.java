...
public class LeaveTest extends BaseTest {
    ...
    public void shouldLoadLeaveListPage() {
        ...
        Assert.assertTrue(count >= 0, "Leave list should load without errors; row count was: " + count);
    }
    ...
    public void shouldCancelLeaveRequestSuccessfully() {
        ...
        Assert.assertTrue(status.contains("Cancelled"), "Leave status should be 'Cancelled', actual: " + status);
    }
}
