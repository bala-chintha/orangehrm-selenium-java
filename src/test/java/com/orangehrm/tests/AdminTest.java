...
public class AdminTest extends BaseTest {
    ...
    public void shouldAddNewUserSuccessfully() throws InterruptedException {
        createUser();
    ...
    public void shouldDeleteUserSuccessfully() throws InterruptedException {
        ...
        adminPage.searchByUsername(user.username);
        Assert.assertTrue(adminPage.isNoRecordsFound(), "Deleted user '" + user.username + "' should not appear in search results");
    }
    ...
    public void shouldSearchByUsernameAndFindResults() {
        ...
        int count = adminPage.getRowCount();
        Assert.assertTrue(count > 0, "Search for '" + UserData.KNOWN_USERNAME + "' should return results");
    }
    ...
    public void shouldShowNoRecordsForInvalidUsernameSearch() {
        ...
        Assert.assertTrue(adminPage.isNoRecordsFound(), "Searching for '" + UserData.NONEXISTENT_USERNAME + "' should show 'No Records Found'");
    }
